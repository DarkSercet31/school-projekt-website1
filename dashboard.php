    ...
    if ($action === 'createuser') {
        ...
        if ($username === '' || $emailN === '') {
            ...
            if ($exists) {
                ...
                $sql = "INSERT INTO user (pk_username, firstName, lastName, password, email, role, mustChangePassword)
                        VALUES (?, ?, ?, ?, ?, ?, 1)";
                ...
                if (mysqli_stmt_execute($stmt)) {
                    $success = ($lang === 'de')
                        ? 'Benutzer wurde angelegt. (Passwort: ChangeMe123)'
                        : 'User has been created. (Password: ChangeMe123)';
                } else {
